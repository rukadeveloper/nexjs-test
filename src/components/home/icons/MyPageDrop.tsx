...
export default function MyPageDrop() {
  return (
    <div className="my__page__dropdown absolute w-[100px] top-full bg-white border border-solid border-gray-100 rounded-sm text-xs pt-2" style={{ display: 'none', boxShadow: '0px 1px 1px 0px rgba(0,0,0,.15)' }}>
      <ul>
